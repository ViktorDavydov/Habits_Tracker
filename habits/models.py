...
class Habit(models.Model):
    ...
    time = models.TimeField(default=timedelta(minutes=1), verbose_name='время')
    ...
    action_time = models.PositiveIntegerField(default=timedelta(minutes=2), verbose_name='время выполнения привычки')
